...
$\begin{equation} \begin{cases} \begin{aligned} -\Delta u &= 0 &&\text{on} \Omega \subset \mathbb{R}^2\\ u &= e^{\sqrt{x^2+y^2}} &&\text{on} \partial \Omega\\ \end{aligned} \end{cases} \end{equation}$
## Multi-Grid Method
<figure>
